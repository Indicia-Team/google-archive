...
class Setup_Controller extends Template_Controller
{
	...
	private function db_connect()
	{
		...
		if(false === $dbconn)
		{
			...
			Kohana::log("error", "Setup failed: db connect error");
		}
	...
	private function get_form_vars()
	{
		...
		$this->view_var['indicia_login']    = trim($_POST['indicia_login']);
		$this->view_var['indicia_password'] = trim($_POST['indicia_password']);
	}
