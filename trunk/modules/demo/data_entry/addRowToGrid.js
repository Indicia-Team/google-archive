	...
	return function() {
		...
		$.getJSON(url+"/taxa_taxon_list/"+ttlId+"?mode=json&callback=?", 
				...
				$.each(data, function(i, item){
					...
					/*
					 * Now we need to clone the sample row, drop in the correct 
					 * values and place it in the correct place in the DOM.
					 */
					...
					// Clone the row, drop it in the correct place and remove
					// its id attribute.
